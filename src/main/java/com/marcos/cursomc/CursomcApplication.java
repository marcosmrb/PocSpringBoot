...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("1232", "3211"));

		Endereco e1 = new Endereco(null, "Rua x", "123", "Apt 20", "Jardim", "123123", cli1, c1);
		Endereco e2 = new Endereco(null, "Rua y", "123", "Apt 10", "Jcrdim", "223123", cli1, c2);
